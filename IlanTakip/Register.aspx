        ...
        <div class="container register">
            <div class="row">
                <div class="col-md-3 register-left">
                    ...
                    <h3>Hoş Geldiniz</h3>
                    <asp:Button class="w-100 btn btn-lg btn-primary" OnClick="RegisterPageLoginButton_Click" ID="RegisterPageLoginButton" runat="server" Text="Giriş yap" />
                ...
                <div class="col-md-9 register-right">
                    <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true">Hirer</a>
                        </li>
                    </ul>
                            ...
                            <div class="row register-form">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="FirtName" placeholder="First Name *" value="" runat="server"/>
                                    </div>
                                    <div class="form-group">
                                ...
                                <asp:DropDownList ID="DropDownList1" runat="server">
                                    <asp:ListItem Text="İş Arayan" Value="Candidate"></asp:ListItem>
                                    <asp:ListItem Text="İş Veren" Value="Employer"></asp:ListItem>
